...
<Nav   />
      ...
      <div className="w-full flex flex-col h-full fixed top-16 p-4 md:p-16 overflow-auto">
        <div className="flex items-center gap-4 mt-8">
          {/* Brand toggle buttons */}
          <button
            className={`rounded-full px-2 gap-1 hover:bg-transparent flex items-center justify-center py-1 text-xs group ${
              !activeBrand
          ...
          {brandDetails.map((brand, index) => (
            <button
              key={index}
              className={`rounded-full gap-1 hover:bg-transparent px-2 flex items-center justify-center py-1 text-xs group ${
